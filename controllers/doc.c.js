...
exports.getDrugReport=async(req,res,next)=>{
    ...
    try {
        const drugs=await DrugsM.getAll();
        res.render('./drug/drug-report', {drugs:drugs,display1: "d-none", display2: "d-block", role: role});
    } catch (err) {
        next(err);
    }
}
...
exports.viewAllDrugReports=async(req,res,next)=>{
    ...
    try {
        ...
        res.render('./drug/drug-report-list', { reports:rs,display1: "d-none", display2: "d-block", role: role });
    } catch (err) {
        next(err);
    }
}
exports.viewDrugReportDetail=async(req,res,next)=>{
    ...
    try {
        ...
        res.render('./drug/drug-report-detail', { drugs:drugs,thang:rs[0].thang,nam:rs[0].nam,data:array,display1: "d-none", display2: "d-block", role: role });
    } catch (err) {
        next(err);
    }
}
