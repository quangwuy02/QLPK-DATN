...
exports.viewAllDrugs = async (req, res, next) => {
    try {
        ...
        if (req.session.Username) {
            res.render('./drug/search-drug', { drugs: rs, display1: "d-none", display2: "d-block", role: role });
        }
        else {
            res.render('./drug/search-drug', { drugs: rs, display1: "d-block", display2: "d-none", role: role });
        }
    } catch (err) {
        next(err);
    }
...
exports.viewAllDoctors = async (req, res, next) => {
    try {
        ...
        if (req.session.Username) {
            res.render('./doctor/search-doctor', { doctors: rs, display1: "d-none", display2: "d-block", role: role });
        }
        else {
            res.render('./doctor/search-doctor', { doctors: rs, display1: "d-block", display2: "d-none", role: role });
        }
    } catch (err) {
        next(err);
    }
...
exports.viewAllPatients = async (req, res, next) => {
    try {
        ...
        if (req.session.Username && req.session.Doctor) {
            ...
            res.render('./pages/error', { patients: rs, display1: "d-block", display2: "d-none", role: role });
        }
    } catch (err) {
        next(err);
    }
...
exports.viewAllRecords=async (req, res, next) => {
    try {
        ...
        if (req.session.Username && req.session.Doctor) {
            ...
            res.render('./pages/error', { display1: "d-block", display2: "d-none", role: role });
        }
    } catch (err) {
        next(err);
    }
