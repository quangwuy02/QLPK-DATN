...
const AddRouter = require('./routers/add.r');
...
app.get('/', async (req, res, next) => {
    ...
    if (req.session.Username) {
        res.render('./home/home', { display1: "d-none", display2: "d-block", doctors: doctors, role: role });
    }
    else {
        res.render('./home/home', { display1: "d-block", display2: "d-none", doctors: doctors, role: role });
    }
});
...
app.all('*', function (req, res) {
    ...
    if (req.session.Username) {
        res.render('./pages/page-not-found', { display1: "d-none", display2: "d-block", role: role });
    }
    else {
        res.render('./pages/page-not-found', { display1: "d-block", display2: "d-none", role: role });
    }
});
